...
select * from student;
select name, birthday from student where substr(birthday,4,2) = '01';
...
select name, pay, bonus, deptno, to_char((pay*12)+nvl(bonus,0),'999,999') from professor where deptno = 201;
